...
<?php $__env->startSection('title','Tiket Eskalasi Vendor'); ?>
...
<div class="bg-white rounded-2xl shadow-sm ring-1 ring-gray-100 p-6">
  <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between mb-4">
    ...
    <form method="GET" action="<?php echo e(route('vendor.dashboard')); ?>" class="grid grid-cols-2 sm:flex gap-2">
      ...
      <?php if(request()->hasAny(['q','kategori'])): ?>
        <a href="<?php echo e(route('vendor.dashboard')); ?>" class="text-sm px-2 py-2 text-gray-600 hover:underline">Reset</a>
      <?php endif; ?>
    </form>
  </div>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr class="hover:bg-gray-50">
            ...
            <td class="py-3 px-4 font-medium">
              <a href="<?php echo e(route('ticket.show', $t->id)); ?>" class="text-indigo-600 hover:underline"><?php echo e($t->nomor_tiket); ?></a>
            </td>
            ...
            <td class="py-3 px-4">
              <a href="<?php echo e(route('ticket.show', $t->id)); ?>" class="inline-flex items-center rounded-lg bg-gradient-to-r from-blue-500 to-sky-500 px-3 py-1.5 text-white hover:bg-gray-800">Detail</a>
            </td>
          </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\helpdesk-app\resources\views/vendor/dashboard.blade.php ENDPATH**/ ?>