    ...
    <table class="min-w-full text-sm">
      ...
      <tbody class="divide-y divide-gray-100">
        ...
        <tr class="hover:bg-gray-50">
          ...
          <td class="py-3 px-4 font-medium"><a href="<?php echo e(route('ticket.show',$t->id)); ?>" class="text-indigo-600 hover:underline"><?php echo e($t->nomor_tiket); ?></a></td>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
      <div class="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
        <div class="flex items-start justify-between gap-3">
          <div>
            <a href="<?php echo e(route('ticket.show',$t->id)); ?>" class="font-semibold text-indigo-600 hover:underline"><?php echo e($t->nomor_tiket); ?></a>
