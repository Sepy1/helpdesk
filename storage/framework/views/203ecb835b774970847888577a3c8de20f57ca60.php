...
<div
  ...
  x-data="{
    ...
    editModalOpen: false,
    createUser: { username: '', name: '', email: '', password: '', role: 'IT', kode_kantor: '', email_notifications_enabled: true, android_notifications_enabled: true },
    editUser: {},
    openCreate() {
      this.createUser = { username: '', name: '', email: '', password: '', role: 'IT', kode_kantor: '', email_notifications_enabled: true, android_notifications_enabled: true };
        ...
        <table class="min-w-full border-collapse text-sm">
          <thead class="sticky top-0 z-10">
            <tr class="bg-violet-50 text-slate-900">
              ...
              <th class="border-b border-violet-100 px-3 py-2.5 text-left font-semibold">Email</th>
              <th class="border-b border-violet-100 px-3 py-2.5 text-left font-semibold">Android</th>
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div class="md:col-span-2 grid grid-cols-1 gap-3 sm:grid-cols-2">
            <label class="flex items-center gap-3 rounded-lg border border-slate-200 px-3 py-2">
              <input type="hidden" name="email_notifications_enabled" value="0">
              <input type="checkbox" name="email_notifications_enabled" value="1" class="h-4 w-4 rounded border-slate-300 text-emerald-600 focus:ring-emerald-500" x-model="createUser.email_notifications_enabled">
              <span>
                <span class="block text-sm font-semibold text-slate-800">Notifikasi Email</span>
                <span class="block text-xs text-slate-500">Kirim notifikasi tiket via email</span>
              </span>
            </label>
            <label class="flex items-center gap-3 rounded-lg border border-slate-200 px-3 py-2">
              <input type="hidden" name="android_notifications_enabled" value="0">
              <input type="checkbox" name="android_notifications_enabled" value="1" class="h-4 w-4 rounded border-slate-300 text-sky-600 focus:ring-sky-500" x-model="createUser.android_notifications_enabled">
              <span>
                <span class="block text-sm font-semibold text-slate-800">Notifikasi Android</span>
                <span class="block text-xs text-slate-500">Kirim push ke aplikasi Android</span>
              </span>
            </label>
          </div>
        </div>
      ...
      <form method="POST" :action="editUser.update_url" class="px-5 py-4">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div class="md:col-span-2 grid grid-cols-1 gap-3 sm:grid-cols-2">
            <label class="flex items-center gap-3 rounded-lg border border-slate-200 px-3 py-2">
              <input type="hidden" name="email_notifications_enabled" value="0">
              <input type="checkbox" name="email_notifications_enabled" value="1" class="h-4 w-4 rounded border-slate-300 text-emerald-600 focus:ring-emerald-500" x-model="editUser.email_notifications_enabled">
              <span>
                <span class="block text-sm font-semibold text-slate-800">Notifikasi Email</span>
                <span class="block text-xs text-slate-500">Kirim email notifikasi</span>
              </span>
            </label>
            <label class="flex items-center gap-3 rounded-lg border border-slate-200 px-3 py-2">
              <input type="hidden" name="android_notifications_enabled" value="0">
              <input type="checkbox" name="android_notifications_enabled" value="1" class="h-4 w-4 rounded border-slate-300 text-sky-600 focus:ring-sky-500" x-model="editUser.android_notifications_enabled">
              <span>
                <span class="block text-sm font-semibold text-slate-800">Notifikasi Android</span>
                <span class="block text-xs text-slate-500">Kirim push ke aplikasi Android</span>
              </span>
