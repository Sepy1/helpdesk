...
<?php $__env->startSection('title','Tiket Vendor Saya'); ?>
...
<div class="bg-white rounded-2xl shadow-sm ring-1 ring-gray-100 p-6">
  <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between mb-4">
    ...
    <form method="GET" action="<?php echo e(route('vendor.tickets')); ?>" class="grid grid-cols-2 sm:flex gap-2">
      <input
        type="text"
        name="q"
      ...
      <select name="status" class="rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
        ...
        <?php $__currentLoopData = ($status ?? ['OPEN','ON_PROGRESS','CLOSED']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <?php if(request()->hasAny(['q','kategori','status'])): ?>
        <a href="<?php echo e(route('vendor.tickets')); ?>" class="text-sm px-2 py-2 text-gray-600 hover:underline">Reset</a>
      <?php endif; ?>
    </form>
  </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\helpdesk-app\resources\views/vendor/my_tickets.blade.php ENDPATH**/ ?>