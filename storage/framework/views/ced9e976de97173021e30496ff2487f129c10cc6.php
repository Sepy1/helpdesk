      ...
      <div class="mt-4 flex items-center justify-between">
        <div>
          ...
          <?php if($ticket->lampiran): ?>
            <a href="<?php echo e(route('ticket.download',$ticket->id)); ?>?inline=1" class="attachment-view inline-flex items-center rounded-md px-2 py-1 text-xs ring-1 ring-gray-200 hover:bg-indigo-50 text-indigo-600">
              Lihat lampiran
            </a>
          <?php else: ?>
          ...
          <div id="c-<?php echo e($c->id); ?>" class="flex <?php echo e($mine ? 'justify-end' : 'justify-start'); ?>" data-comment-ts="<?php echo e(optional($c->created_at)->format('c')); ?>">
            <div class="max-w-[85%] sm:max-w-[78%]">
              ...
              <div class="mt-1 inline-block rounded-2xl px-2 py-1.5 text-xs leading-snug break-words shadow-sm <?php echo e($mine ? 'bg-emerald-500 text-white rounded-br-sm' : 'bg-gray-100 text-gray-800 rounded-bl-sm'); ?>">
                ...
                <?php if($c->attachment): ?>
                  <div class="mt-2">
                    <a href="<?php echo e(route('comment.download', $c->id)); ?>?inline=1" class="attachment-view inline-flex items-center px-2 py-1 rounded-md ring-1 ring-white/40 text-xs <?php echo e($mine ? 'bg-white/10 text-white hover:bg-white/20' : 'bg-white text-indigo-600 hover:bg-indigo-50 ring-indigo-200'); ?>">Lampiran</a>
                  </div>
                <?php endif; ?>
              </div>
