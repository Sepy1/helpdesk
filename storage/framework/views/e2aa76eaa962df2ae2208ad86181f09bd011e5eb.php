...
<div class="max-w-lg mx-auto bg-white rounded-2xl shadow-sm ring-1 ring-gray-100 p-3 sm:p-5 text-xs sm:text-sm">
  ...
  <form method="POST" action="<?php echo e(route('it.users.update', $user)); ?>" class="space-y-4">
    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
    <div>
      <label class="text-sm font-medium text-gray-700">Username</label>
      <input type="text" name="username" value="<?php echo e(old('username', $user->username)); ?>" class="mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" required />
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
      ...
      <input type="text" name="name" value="<?php echo e(old('name', $user->name)); ?>" class="mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" required />
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
      ...
      <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" class="mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" required />
    ...
    <div>
      ...
      <select name="role" class="mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" required>
        <?php $__currentLoopData = ['IT','CABANG','VENDOR','ADMIN']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($r); ?>" <?php if(old('role',$user->role)===$r): echo 'selected'; endif; ?>><?php echo e($r); ?></option>
    ...
    <div>
      ...
      <select name="kode_kantor" class="mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
        ...
        <?php $__currentLoopData = $kodeKantors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($kk->kode); ?>" <?php if(old('kode_kantor', $user->kode_kantor) === $kk->kode): echo 'selected'; endif; ?>><?php echo e($kk->kode); ?> — <?php echo e($kk->nama_kantor); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </select>
      <p class="mt-1 text-xs text-gray-500">Opsional.</p>
      <?php $__errorArgs = ['kode_kantor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="text-xs text-red-600 mt-1"><?php echo e($message); ?></div><?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\helpdesk-app\resources\views/it/users/edit.blade.php ENDPATH**/ ?>