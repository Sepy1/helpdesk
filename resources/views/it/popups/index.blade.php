        ...
        @forelse($popups as $popup)
          <div class="rounded-2xl border border-slate-200 p-4">
            <div class="flex flex-col gap-4 md:flex-row">
              @if($popup->image_path)
                <img src="{{ route('it.popups.image', $popup) }}" class="h-36 w-full rounded-xl object-cover md:w-48" alt="{{ $popup->title }}">
              @endif
              <div class="min-w-0 flex-1">
                ...
                <div class="mt-4 flex flex-wrap gap-2">
                  <button
                    ...
                    @click="preview = { title: @js($popup->title), image: @js($popup->image_path ? route('it.popups.image', $popup) : ''), description: @js($popup->description ?? '') }; previewOpen = true"
                  >
                    Preview
                  </button>
