...
<div class="bg-white rounded-2xl shadow-sm ring-1 ring-gray-100 p-5">
  <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
    <div>
      ...
      <p class="text-sm text-gray-500">Daftar tiket dari seluruh cabang. Klik nomor tiket untuk detail.</p>
    </div>

    {{-- Filter --}}
    <form method="GET" action="{{ route('it.dashboard') }}" class="grid grid-cols-2 sm:flex gap-2">
...
<div class="mt-4 grid gap-3 md:hidden">
  ...
  @empty
    <div class="rounded-xl border border-dashed p-6 text-center text-gray-500">Tidak ada tiket.</div>
  @endforelse
</div>
  ...
  <table class="min-w-full text-sm">
    <thead class="bg-gray-50 text-gray-600">
      <tr>
        ...
        <th class="py-3 px-4 text-left">IT</th>
    ...
    <tbody class="divide-y divide-gray-100">
        ...
        <tr class="hover:bg-gray-50">
          ...
          <td class="py-3 px-4">
            <div class="flex flex-wrap gap-2">
              ...
              @elseif($t->status === 'ON_PROGRESS' && $t->it_id === auth()->id())
      ...
      @empty
        <tr><td colspan="8" class="py-6 px-4 text-center text-gray-500">Tidak ada tiket.</td></tr>
      @endforelse
    </tbody>
  </table>
</div>
